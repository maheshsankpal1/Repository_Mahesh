...
public class PrintOnWood extends CanvasProductPage {
	...
	public PrintOnWood(WebDriver driver) {
		super(driver);
	}
	...
	public void selectPrintOnWood() {
		Select select = new Select(productTypeDropdown); // Initialize Select class with the dropdown WebElement
		select.selectByVisibleText("Print On Wood"); // Select option by visible text
	}
